...
// IterToKeys converts a sequence of keys into a key to empty-struct sequence.
...
// IterMap yields f(v) for every value v from src.
...
// IterFilter returns a sequence of values from slice s that satisfy p.
