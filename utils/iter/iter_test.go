...
func TestMapTo2(t *testing.T) {
	src := slices.Values([]string{"a", "bb", "ccc"})
...
func TestMap2To1(t *testing.T) {
	src := slices.All([]int{2, 4}) // (0,2),(1,4)
...
func TestFilter(t *testing.T) {
	src := slices.Values([]int{1, 2, 3, 4, 5})
...
func TestFilter2(t *testing.T) {
	src := slices.All([]string{"a", "b", "c"}) // (0,"a"),(1,"b"),(2,"c")
...
func TestFind(t *testing.T) {
	src := slices.Values([]int{10, 20, 30})
...
func TestFind2(t *testing.T) {
	src := slices.All([]string{"a", "b"}) // (0,"a"),(1,"b")
	if k, v, ok := uiter.Find2(src, func(k int, _ string) bool { return k == 1 }); !ok || k != 1 || v != "b" {
